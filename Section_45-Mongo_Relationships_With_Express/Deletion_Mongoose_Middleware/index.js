...
app.get('/farms/:id', async (req, res) => {
    ...
    //Then use: findById(id) and 
    //.populate('<new of the attribute that is referencing the documents with .ref>') to get the farm 
     //And it associted products from the database
     const farm = await Farm.findById(id)
                            .populate('products');
...
app.get('/farms/:id/products/new', async (req, res) => {
    ...
    //Pass the categories list a product can be And the farm of the farm
    // to the EJS Page 
...
app.post('/farms/:id/products', async (req, res) => {
    ...
    //THEN REDIRECT TO the show of the farm found 
...
/***************************************************************
 * ************************************************************
 *          DELETING A FARM AND IT ASSOCIATED PRODUCT         *
 * ************************************************************
*****************************************************************/
app.delete('/farms/:id', async (req,res) => {
    //Use findByIdAndDelete(req.params.id) and pass in req.params.id
    const farmDeleted = await Farm.findByIdAndDelete(req.params.id);

    //After deleting the farm, now delete all of the associated objects 
     //In relation to the farm deleted by using the findOneAndDelete 
       //middleware defined in the farm.js file as a schema  
    

    //Then redirect to the farm page
    res.redirect('/farms')
})

/***************************************************************
 * ************************************************************
 *        End of DELETING A FARM AND IT ASSOCIATED PRODUCT    *
 * ************************************************************
*****************************************************************/
...
app.get('/products/:id', async (req, res) => {
    ...
    //Then use: findById(id) to get the product from the database and 
    //.populate('<new of the attribute that is referencing the documents with .ref>') to get the Product 
    //And it associted farm from the database (get the only the farm name)
