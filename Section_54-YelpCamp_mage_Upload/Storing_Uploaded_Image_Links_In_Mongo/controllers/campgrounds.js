...
module.exports.createCampground = async (req, res, next) => {
    ...
    console.log(req.user._id);
      ...
      /*********************************************************
     *  With multer you will get have access to files 
     *   the request body
     * 
     *  you can now use: 
     *     req.files 
     *   and create an object with: .map for only 
     *              the file path  (the image url)
     *              the file name (the image name)
     *  to get the information required
     * 
     * and then add it to the Campground object create with
     *  campgroud.images
     *        images is the field name if the array created 
     *        in the database model for campgroud.
    *********************************************************/ 
