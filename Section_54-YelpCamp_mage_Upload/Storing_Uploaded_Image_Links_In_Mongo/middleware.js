...
module.exports.isReviewAuthor = async (req, res, next) => {
  //Get the Id of the campground and the reviewId of the review through req.params
   // and use desturturing to create an id variable to save it to
  const {id, reviewId } = req.params;
  
  /*************************************************************
       *  In other to make sure the user that created the review 
       *  is the only one that can DELETED the review 
       *  
       *  you will need to :
       *   - first find the review in the database
       *   - then compare the review.author id reference
       *   - to the req.user.id of the user currently logged in
       *   
  ****************************************************************/
  //find the review
  ...
  //then compare the review.author id reference to the req.user._id
   // if they are not equals then show the user a flash error message
    // and redirect to the user to the show page of the campground
