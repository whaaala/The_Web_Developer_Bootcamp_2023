...
app.post('/campgrounds', catchAsync(async (req, res, next) => {
   //Check if req.body.campground is not passed (if there is no required DATA is passed in)
...
app.use((err, req, res, next) => {
   ...
   //Use the eror message and status code thrown by the ExpressError class 
