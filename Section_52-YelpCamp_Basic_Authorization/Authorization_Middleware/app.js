...
app.use(passport.session())
   ...
   *  
   *   This is tell passport to use the locaStrategy that is required
...
app.use((req, res, next)  => {
   /*****************************************************************
     *  There is an attribute on the request object called: user
     *   this attribute will contain in an object that holds
     *      information about the user that is logged in
     *   
     *  FYI: 
     *    this attribute is put there by PASSPORT 
     *     and PASSPORT will automatically filled in the deserialized 
     *      information from the session for the user logged in
     * 
     * Use this attribute to store the information of the user
     *  that can then be accessed in this middleware for every request
   ********************************************************************/
