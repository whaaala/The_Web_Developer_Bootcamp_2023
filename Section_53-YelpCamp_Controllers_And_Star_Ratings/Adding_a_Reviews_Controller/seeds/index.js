...
/*     //Create a new campground object
   ...
   for(let i = 0; i <50; i++) {
      ...
      //generate a random for price
      const price = Math.floor(Math.random() *20) + 20;

      //Create a new campground object
      const camp = new Campground({
         //Set the author to have a user id of tim  (DO NOT DELETE TIM in the database)
         author: '64fa047267654fc2fb5e9fc6',
        ...
        //Add random camping images from unplash for each document
        image: 'https://source.unsplash.com/random/?camping', 

        //Add a discription for each document
        description: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut odio similique impedit, doloribus veritatis dolores eius laudantium officia vel nihil ea molestias illum maxime, aliquam quod. Tempore enim excepturi eiusLorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, amet delectus! Deleniti enim dolores voluptate ex error. Dolorum quibusdam beatae ex et perferendis quisquam facilis exercitationem quo. Corporis, perspiciatis voluptate!',
        //Add a price with a random number
        price: price
