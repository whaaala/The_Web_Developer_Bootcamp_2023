...
router.post('/register', catchAsync(async (req, res, next) => {
   ...
   try{
     ...
     const registeredUser = await User.register(user, password);
             ...
             /**********************************************
              *  When a user is registration successful 
              *   you want to log the user in automatically
              * 
              * passport provides an helper method called:
              *       login()
              * 
              * this login() method esterblishes a login
              *  session
              * 
              * the method requires a callback function
             ************************************************/
     req.login(registeredUser, err => {
       //if an error occurs 
       if(err) {
         // call the next function and pass the error that caused the occurred 
