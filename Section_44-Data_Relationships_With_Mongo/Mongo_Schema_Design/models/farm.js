...
//Find a farm 
//Farm.findOne({name:'Full Belly Frams'}).then(farm => console.log(farm));
//With this statement, the products attribute value array will contain the objectIds for the referenced products
 //NOT the products themselves

/*********************************************************
 *  To get the products attribute value array
 *  to display the DATA for each of the referenced products
 *   use: .populate(<the name of the property>) method
 *   to chain the findOne() method on farm
 ****************************************************************/
